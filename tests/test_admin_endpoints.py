...
async def test_normal_user_cannot_create_user(client: AsyncClient, db: AsyncSession):
    ...
    await client.post("/v1/auth/login", json={"username": "admin", "password": admin_password})
...
async def test_normal_user_cannot_update_user(client: AsyncClient, db: AsyncSession):
    ...
    admin_login = await client.post("/v1/auth/login", json={"username": "admin", "password": admin_password})
